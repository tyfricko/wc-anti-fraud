...
if ( ! class_exists( 'WCAF_Bulk_Blacklist' ) ) {

	/**
	 * Class WCAF_Bulk_Blacklist
	 */
	class WCAF_Bulk_Blacklist {

		/**
		 * WCAF_Bulk_Blacklist constructor.
		 */
		...
		public function register_bulk_action( $bulk_actions ) {
			$bulk_actions['blacklist-customer'] = __( 'Blacklist Customer', 'wc-anti-fraud' );
