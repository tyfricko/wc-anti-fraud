 ...
 */
class WCAF_Logs_Table extends WP_List_Table {
	/**
	 * Prepare the items for the table to process
	 *
	 * @return Void
	 */
	protected $table = 'wcaf_logs';
	...
	public function no_items() {
		_e( 'No Log records available.', 'wc-anti-fraud' );
	}
	...
	public function process_bulk_action() {
		if ( 'delete' === $this->current_action() ) {
			...
			wp_redirect( admin_url( 'admin.php?page=wcaf' ) );
		}
	...
	public function delete_log( $id ) {
		$log_handler = new WCAF_Logs_Handler();
